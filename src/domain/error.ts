...
export function isHTTPError(err: unknown): err is OpenFetchError {
  return (
    err instanceof OpenFetchError &&
...
export function isTimeoutError(err: unknown): err is OpenFetchError {
  return (
    err instanceof OpenFetchError &&
